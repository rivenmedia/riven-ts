...
| **`updateIntervalSeconds`** (\*) | Interval in seconds to update content. If using the webhook, set to `null` to disable automatic updates (an initial request will still be made on startup) | `number` (_≥0_)                                                                                                            | `60`                      |
