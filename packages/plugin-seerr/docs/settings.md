...
| `autofixMetadataProvider` | Automatically fix metadata provider settings in Seerr if they are incorrect                                                                                | `boolean`                                                                                                                  | `false`                   |
| `autofixWebhookBody`      | Automatically fix webhook body settings in Seerr if they are incorrect (required for request approval events to work)                                      | `boolean`                                                                                                                  | `false`                   |
