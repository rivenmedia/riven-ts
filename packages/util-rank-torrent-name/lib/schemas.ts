...
export const ParsedDataSchema = z
  .object({
    ...
    dubbed: optionalBoolean,
    subbed: optionalBoolean,
    hardcoded: optionalBoolean,
    proper: optionalBoolean,
    repack: optionalBoolean,
    remux: optionalBoolean,
    retail: optionalBoolean,
    upscaled: optionalBoolean,
    remastered: optionalBoolean,
    extended: optionalBoolean,
    convert: optionalBoolean,
    unrated: optionalBoolean,
    uncensored: optionalBoolean,
    documentary: optionalBoolean,
    commentary: optionalBoolean,
    threeD: z.coerce.boolean().optional(),
    ppv: optionalBoolean,
    date: optionalNonEmptyString,
    group: optionalNonEmptyString,
    edition: optionalNonEmptyString,
    network: optionalNonEmptyString,
    region: optionalNonEmptyString,
    site: optionalNonEmptyString,
    size: optionalNonEmptyString,
    container: optionalNonEmptyString,
    extension: optionalNonEmptyString,
    episodeCode: optionalNonEmptyString,
    releaseTypes: z.array(nonEmptyString).optional(),

    // Custom fields
    adult: optionalBoolean,
    scene: optionalBoolean,
    trash: optionalBoolean,
    country: optionalNonEmptyString,
    bitrate: optionalNonEmptyString,
  })
  .transform((data) => ({
    ...data,
    type:
