<script lang="ts">
  ...
  import {
    MediaListStore,
    type BaseListItem,
  } from "$lib/services/lists-cache.svelte";
...
{#snippet listHeading(title: string)}
  <div class="flex items-center gap-3">
    ...
    ></div>
    <h2
      class="text-foreground text-2xl font-bold tracking-tight drop-shadow-md"
    >
      {title}
    </h2>
  </div>
...
>
  ...
  <div class="relative z-10 flex w-full flex-col gap-10 pb-24 md:gap-12">
    ...
    <div
      class="mx-auto flex w-full max-w-600 flex-col gap-12 px-6 md:px-12 lg:px-16"
    >
