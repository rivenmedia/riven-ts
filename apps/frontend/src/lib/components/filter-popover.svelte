<script lang="ts">
  ...
  let voteAverageRange = $derived([
    filterStore.voteAverageMin,
    filterStore.voteAverageMax,
  ]);
  let voteCountRange = $derived([
    filterStore.voteCountMin,
    filterStore.voteCountMax,
  ]);
