...
>
  <div
    class="pointer-events-auto flex w-full items-center justify-between gap-6"
  >
    <div
      class="mx-auto w-full max-w-lg transition-all duration-300 focus-within:max-w-xl"
    >
      <InputGroup.Root
    ...
    <div class="flex items-center gap-2">
      <div class="md:hidden">
        <NotificationCenter
          class="bg-background/60 rounded-xl backdrop-blur-md"
        />
      </div>
