...
import { indexShowMutation } from "./index-show.mutation.ts";
...
it("returns the media item if processed successfully", async ({
  ...
  const result = await indexShowMutation(em, {
    id: itemRequest.id,
    title: "Test Show",
    imdbId: requestedId,
    contentRating: "tv_14",
...
it("updates the media item with the latest data if it already exists", async ({
  ...
  const initialShow = await indexShowMutation(em.fork(), {
    id: itemRequest.id,
    title: "Test Show",
    imdbId: requestedId,
    contentRating: "tv_14",
  ...
  const updatedUpcomingShow = await indexShowMutation(em.fork(), {
    id: itemRequest.id,
    title: "Test Show",
    imdbId: requestedId,
    contentRating: "tv_14",
  ...
  const updatedOngoingShow = await indexShowMutation(em.fork(), {
    id: itemRequest.id,
    title: "Test Show",
    imdbId: requestedId,
    contentRating: "tv_14",
  ...
  const updatedOngoingShowWeekTwo = await indexShowMutation(em.fork(), {
    id: itemRequest.id,
    title: "Test Show",
    imdbId: requestedId,
    contentRating: "tv_14",
